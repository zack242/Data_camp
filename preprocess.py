...
direction_to_degree = {'N':np.random.uniform(348.75, 360) if np.random.uniform(0, 1)<0.5 else np.random.uniform(0, 11.25),
...
def get_datetime(df:pd.DataFrame):
    ...
    df.drop(['dateInt', 'Date', 'No'], axis=1, inplace=True)
